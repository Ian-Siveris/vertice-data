import { X, FileText, FileBadge, ExternalLink } from 'lucide-react';
...
export function ResumoModal({ isOpen, onClose, licitacao }: ResumoModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] overflow-y-auto bg-slate-900/50 backdrop-blur-sm">
      <div className="flex min-h-full items-center justify-center p-4 text-center">
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh] text-left align-middle transition-all">
          ...
          <div className="p-6 overflow-y-auto">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  Compatibilidade: {licitacao.score}%
                </span>
              </div>
              ...
              <p className="text-slate-700 leading-relaxed bg-brand-light p-4 rounded-lg border border-slate-100 text-justify">
                {licitacao.justificativa
                  ? licitacao.justificativa
                  : 'Análise detalhada indisponível.'}
              </p>
            </div>
              ...
              >
                ...
                <div>
                  <p className="font-bold text-slate-700 text-sm">
                    Leitura Completa do PDF do Edital
                  </p>

                  <p className="text-xs text-slate-500 mt-1">
                    Aceda à página oficial do governo para baixar os anexos e rever as regras completas.
                  </p>
                </div>
              </button>
            </div>
